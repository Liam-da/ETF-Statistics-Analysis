...
- Six ETF pair portfolios  
- Portfolio variance minimization  
- Optimal weights and minimum variance tables

### 3. Distribution Analysis
- Histogram and QQ-plots  
- Normality assessment for AGG, VAW, IWN, SPY  
- Use of Central Limit Theorem for inference  
